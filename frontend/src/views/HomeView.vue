  ...
  <div class="home-view">
    ...
    <main class="overworld-content">
      ...
      <section id="about" class="hero-section">
        ...
        <div class="why-selection-card">
          <div class="why-selection-header">
            <span class="selection-badge">💡 WHY MOD COMPASS</span>
            <h2>수많은 주제 중 'Mod Compass'를 선택한 이유</h2>
          </div>
        ...
        <div class="why-story-card">
          <div class="why-story-header">
            <span class="why-badge">🧱 PHILOSOPHY &amp; PROJECT GOAL</span>
            <h2>왜 수많은 게임 중 마인크래프트와 로블록스 인가요?</h2>
          </div>
      ...
      <section id="ai-agent-arch" class="agent-arch-section">
        <div class="agent-arch-header">
          <span class="agent-arch-badge">🧠 AI AGENT ARCHITECTURE</span>
          <h2>사용자 기반 AI Agent 설계 구조</h2>
